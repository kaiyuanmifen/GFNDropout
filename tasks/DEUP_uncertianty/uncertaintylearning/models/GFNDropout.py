...
class GFNDropout(BaseModel):
    def __init__(self, train_X, train_Y,
        ...
        self.f_predictor = network#this needs to be a GFNDropout
        self.mask=mask#which mask to be used need to be defined options:"none",random,"topdown","bottomup","upNdown"
        self.device = device
...
######codes related to MLP GFN dropout 
