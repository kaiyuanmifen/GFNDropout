...
#SBATCH --time=0-0:19            # time (DD-HH:MM)
...
model_file="../../checkpoints/${dataset}/${dataset}_${method}_${seed}.model"



declare -a corruptions=("none")

declare -a severities=(0) 

declare -a augment_tests=(True) 
...
do
	...
	do
		...
		for augment_test in "${augment_tests[@]}"
		do
